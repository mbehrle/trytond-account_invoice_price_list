...
name = 'm9s_account_invoice_price_list'
download_url = 'https://gitlab.com/m9s/account_invoice_price_list.git'
requires = []
...
setup(name=name,
    version=version,
    description='Tryton Account Invoice Price List Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/account_invoice_price_list.git',
        },
    keywords='',
    package_dir={'trytond.modules.account_invoice_price_list': '.'},
    packages=(
        ['trytond.modules.account_invoice_price_list']
        + ['trytond.modules.account_invoice_price_list.%s' % p
